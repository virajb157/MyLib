        ...
        et_search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                for(int i = 0; i <bookbean.size(); i++) {
                    if (bookbean.get(i).getBookName().toLowerCase().contains(s.toString().toLowerCase()) || bookbean.get(i).getAuthorName().toLowerCase().contains(s.toString().toLowerCase()) || bookbean.get(i).getCategoryName().toLowerCase().contains(s.toString().toLowerCase())){
